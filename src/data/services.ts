...
export const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    subtitle: 'Develop precision CAD shop drawings and material mood boards based on architectural designs.',
    description: 'Working directly from your architect or designer’s project drawings, our technical team crafts comprehensive material mood boards, precision CAD shop detailing, concealed fastening layouts, and substructure load calculations for seamless site execution.',
    deliverables: [
      'Custom material mood boards created based on architectural designs',
      'Architectural CAD shop drawings & junction detailing',
      'Substructure load calculations & structural engineering reports',
    ],
